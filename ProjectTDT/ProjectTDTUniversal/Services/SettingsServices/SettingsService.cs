...
namespace ProjectTDTUniversal.Services.SettingsServices
{
    ...
    public partial class SettingsService : ISettingsService
    {
        ...
        public bool LoginStatus
        {
            get
            {
                return _helper.Read<bool>(nameof(LoginStatus),false);
            }
            set
            {
                _helper.Write<bool>(nameof(LoginStatus), value);
                ApplyLoginStatus(value);
            }            
        }
        ...
        public string UserName
        {
            get
            {
                return _helper.Read<string>(nameof(UserName), "...");
            }

            set
            {
                _helper.Write<string>(nameof(UserName), value);                
            }
        }
    }
}
